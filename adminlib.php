...
/**
 * This file contains the classes for the admin settings of the peerwork module.
 *
...
/**
 * Admin external page that displays a list of the installed  plugins.
 *
 * @package   mod_peerwork
...
class peerwork_plugin_manager {
    ...
    private function view_header() {
        ...
        echo $OUTPUT->header();
        echo $OUTPUT->heading(get_string('manage' . $this->subtype . 'plugins', 'peerwork'));
    }
