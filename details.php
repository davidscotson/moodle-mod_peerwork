...
// Print the standard page header and check access rights before processing parameters or database records.
...
// Validate group belongs to the course to prevent IDOR and information leakage.
