...
// Print the standard page header and check access rights before executing parameter-based database lookups.
require_login($course, true, $cm);
$context = context_module::instance($cm->id);
require_capability('mod/peerwork:grade', $context);

// Validate that group belongs to the course to prevent IDOR vulnerabilities.
