...
// Print the standard page header and check access rights before executing parameter-based DB lookups.
require_login($course, true, $cm);
$context = context_module::instance($cm->id);
require_capability('mod/peerwork:grade', $context);

// Validate that the provided group belongs to this course.
