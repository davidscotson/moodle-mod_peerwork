...
// Security: Validate that the peerwork ID matches the course module.
if ($peerworkid != $cm->instance) {
    throw new moodle_exception('invalidpeerworkid', 'mod_peerwork');
}

// Security: Validate that the group belongs to the course.
...
// Security: Validate that the user belongs to the group.
