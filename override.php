...
// Security check: ensure peerworkid matches this course module's instance.
if ($peerworkid != $cm->instance) {
    throw new moodle_exception('invalidpeerworkid', 'mod_peerwork');
}

// Security check: ensure group belongs to this course.
...
// Security check: ensure gradedbyid is a member of this group.
