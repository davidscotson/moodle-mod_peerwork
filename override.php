...
// Validate peerwork ID to match course module instance ID.
...
// Validate that the gradedby user is actually a member of the specified group.
if (!array_key_exists($gradedbyid, $members)) {
