...
$string['invalidgroupid'] = 'Invalid group ID provided.';
$string['invalidpaweighting'] = 'Invalid weighting';
$string['invalidpeerworkid'] = 'Invalid peer assessment ID provided.';
$string['invalidscale'] = 'Invalid scale. Please select from options above.';
$string['invaliduserid'] = 'Invalid user ID provided.';
