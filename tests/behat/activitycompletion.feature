...
Feature: Assignment submissions
  ...
  Scenario: Students who grades every peer is shown as completed
    ...
    Then the "Test peerwork name" "activity" should have the "Completed" completion state
    And I log out
  ...
  Scenario: Students who has not graded every peer is not shown as completed
    ...
    When I am on "Course 1" course homepage
    Then the "Test peerwork name" "activity" should have the "To do" completion state
    And I log out
